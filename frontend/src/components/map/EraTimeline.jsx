                                            ...
                                            className={`
                                                ...
                                                ${
                                                    isActive
                                                        ...
                                                        ? "scale-110 border-[#327044] bg-[#F5F3E9] shadow-[0_0_0_5px_rgba(95,150,63,0.14)]"

                                                        : "border-[#718271] bg-[#E9EFE4] group-hover:border-[#5F963F]"
                                                }
                                            `}
                                        >
                                            ...
                                            ${
                                                isActive
                                                    ...
                                                    ? `
                                                        border-[#5F963F]/30
                                                        bg-[#F5F7F1]
                                                        shadow-[0_10px_26px_rgba(48,112,64,0.13)]
                                                        ring-1
                                                        ring-[#5F963F]/10
                                                    `
