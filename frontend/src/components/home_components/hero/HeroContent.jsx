...
export default function HeroContent() {
    return (
        <div className="max-w-2xl">
            ...
            {/* Description */}
            <p className="mt-4 lg:mt-4 xl:mt-6 max-w-lg text-base lg:text-lg leading-7 lg:leading-8 text-[#222D1F] font-medium opacity-95">
            ...
            {/* Stats */}
            <div className="mt-4 lg:mt-4 xl:mt-6">
                <HeroStats />
            </div>
