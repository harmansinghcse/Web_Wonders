    ...
    return (
        ...
        <div className="w-full max-w-[620px] space-y-10">
            ...
            <div>
                ...
                <h2 className="text-4xl sm:text-6xl md:text-[82px] font-black leading-[0.9] md:leading-[0.82] tracking-[-0.04em] text-[#202020]">
                    Interactive
            ...
            <p className="max-w-[580px] text-lg sm:text-[22px] leading-8 sm:leading-[44px] text-[#5A5A5A]">
