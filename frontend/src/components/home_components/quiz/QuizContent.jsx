...
export default function QuizContent() {
    return (
        <motion.div
            ...
            className="w-full max-w-[620px] mx-auto lg:mx-0 space-y-5 sm:space-y-6"
        >
            ...
            <motion.div variants={itemVariants}>
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-black leading-[1.0] lg:leading-[0.95] tracking-[-0.03em] text-[#1E251C]">
                    Interactive
            ...
            <motion.p
                ...
                className="max-w-[540px] text-sm sm:text-base md:text-[17px] leading-6 sm:leading-7 md:leading-[28px] text-[#2C3B24] font-medium opacity-90"
            >
